...
Gem::Specification.new do |s|
  ...
  # Testing
  s.add_runtime_dependency 'facterdb', '~> 3'
  s.add_runtime_dependency 'metadata-json-lint', '~> 4.0'
  s.add_runtime_dependency 'parallel_tests', '>= 4.2', '< 6'
  s.add_runtime_dependency 'puppet_fixtures', '>= 0.1.1', '< 2.0.0'
  s.add_runtime_dependency 'puppet-strings', '>= 4.0.0', '< 6.0.0'
  ...
  s.add_runtime_dependency 'syslog', '>= 0.3.0', '< 2.0.0'

  # Rubocop
  # newest versions that still support Ruby 2.6
  # jruby 9.3 in Puppetserver 7 is compatible with C Ruby 2.6
  s.add_runtime_dependency 'rubocop', '>= 1.50.0', '< 2.0.0'
  s.add_runtime_dependency 'rubocop-rake', '>= 0.6.0', '< 2.0.0'
  s.add_runtime_dependency 'rubocop-rspec', '>= 2.20.0', '< 4.0.0'
  ...
  # development
  s.add_development_dependency 'rspec', '>= 3.12', '< 4.0.0'
end
